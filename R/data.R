...
#' being 47 of them patients with cachexia and 30 control patients.
#'
...
#' format from mouse spinal cord, divided into 2 groups: the wild type
#' and the knockout group. The data was obtained from MetaboAnalyst and
#' originates from a study describing a general strategy for identifying
#' endogenous substrates of enzymes by untargeted LC-MS analysis of tissue
#' metabolomes from wild-type and enzyme-inactivated organisms.
#'
#' @format An object of class \code{"list"}
#'
...
#' \item{\code{NUCLEUS}}{a character vector mentioning the nucleus examined. All observations are '1H'.}
...
#' \item{\code{ORIGINAL_DATABASE_ID}}{whenever available, a character vector with the ID of the corresponding spectra from the database where it was originally acquired.}
#' \item{\code{DATABASE}}{a character vector specifying from which database the spectra were taken.}
#' }
#'
#' @references The spectra were taken from the following databases: HMDB,
#' BMRB and SDBS. Some spectra were internally acquired and are mentioned
#' as OUR in the DATABASE variable.
"spectra_options"